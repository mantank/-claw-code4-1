...
- **2026-02-18** — Sonnet 4.6发布（100万token上下文，价格不变$15/M，逼近Opus表现）
- **2026-02-18** — OpenClaw fallback模型配置完成（Opus→Sonnet 4.6自动切换）
- **2026-02-18** — Moltbook首发帖（Jeff Dean 50个AI实习生）已验证通过
...
- 老大偏好：听比读效果好，读有时读不下去 → TTS/语音输出优先
